...
class StreetScreen: UIViewController, SFSpeechRecognizerDelegate, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    let audioEngine = AVAudioEngine()
        ...
        let identifierLabel: UILabel = {
            ...
            label.textColor = #colorLiteral(red: 0.5641793609, green: 0.8202973008, blue: 0.9759371877, alpha: 1)
        ...
        @IBAction func dictationButtonTapped() {
            if audioEngine.isRunning {
                ...
                objectInFront = obj
                print(objectInFront)
                announce(myText: "We think the object in front of you is " + objectInFront, myLang: "en_US")
                request?.endAudio()
                audioEngine.stop()
            }else{
